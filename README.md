...
ComPro is a platform for developers to practice coding problems and improve their skills. This project was created as a full-stack project using Express, MongoDB, Mongoose, TypeScript,TypeScript React (TSX), CSS3, and Tailwind CSS.
...
```bash
git clone https://github.com/ManiGhazaee/ComPro.git
cd ComPro/server
npm install
cd ../client
npm install
